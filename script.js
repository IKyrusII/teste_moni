...
function salvarAnalise() {
    ...
    // Armazenar texto em observações 
    dadosAnalise.observacao = document.getElementById('observacao').value;
...
// Função para adicionar comportamento de accordion
...
// Chamar a função de inicialização dos accordions
document.addEventListener("DOMContentLoaded", menuAccordion);
